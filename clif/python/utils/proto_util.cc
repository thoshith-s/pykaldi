...
#include "/pykaldi/tools/clif_backend/llvm/tools/clif/python/types.h"
...
static PyObject* get_fqname(PyObject* self, void* xdata) {
  auto cpp = ThisPtr(self); if (!cpp) return nullptr;
  return Clif_PyObjFrom(cpp->fqname, _1);
}
...
static int set_fqname(PyObject* self, PyObject* value, void* xdata) {
  ...
  PyObject* s = PyObject_Repr(value);
  PyErr_Format(PyExc_ValueError, "%s is not valid for fqname:str", s? PyUnicode_AsUTF8(s): "input");
  Py_XDECREF(s);
  return -1;
}
...
static PyObject* get_package(PyObject* self, void* xdata) {
  auto cpp = ThisPtr(self); if (!cpp) return nullptr;
  return Clif_PyObjFrom(cpp->package, _1);
}
...
static int set_package(PyObject* self, PyObject* value, void* xdata) {
  ...
  PyObject* s = PyObject_Repr(value);
  PyErr_Format(PyExc_ValueError, "%s is not valid for package:str", s? PyUnicode_AsUTF8(s): "input");
  Py_XDECREF(s);
  return -1;
}
...
static PyObject* get_srcfile(PyObject* self, void* xdata) {
  auto cpp = ThisPtr(self); if (!cpp) return nullptr;
  return Clif_PyObjFrom(cpp->srcfile, _1);
}
...
static int set_srcfile(PyObject* self, PyObject* value, void* xdata) {
  ...
  PyObject* s = PyObject_Repr(value);
  PyErr_Format(PyExc_ValueError, "%s is not valid for srcfile:str", s? PyUnicode_AsUTF8(s): "input");
  Py_XDECREF(s);
  return -1;
}
...
static int set_request(PyObject* self, PyObject* value, void* xdata) {
  ...
  PyObject* s = PyObject_Repr(value);
  PyErr_Format(PyExc_ValueError, "%s is not valid for request:ProtoTypeInfo", s? PyUnicode_AsUTF8(s): "input");
  Py_XDECREF(s);
  return -1;
}
...
static int set_reply(PyObject* self, PyObject* value, void* xdata) {
  ...
  PyObject* s = PyObject_Repr(value);
  PyErr_Format(PyExc_ValueError, "%s is not valid for reply:ProtoTypeInfo", s? PyUnicode_AsUTF8(s): "input");
  Py_XDECREF(s);
  return -1;
}
...
static PyMethodDef Methods[] = {
  ...
  {C("__nonzero__"), (PyCFunction)wrapIsValid_as___nonzero__, METH_NOARGS, C("__nonzero__() -> bool\n  Calls C++ function\n  bool ::clif_proto::ProtoFileInfo::IsValid()")},
...
static struct PyModuleDef Module = {
  ...
  "clif.python.utils.proto_util",  // module name
  "CLIF-generated module for clif/python/proto_util.h", // module doc
